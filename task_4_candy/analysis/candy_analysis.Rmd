...
# Feel like this could be updated with an if else or case when function
# these strings won't be picked up by non-candy columns as they are capitalised and the other columns are lower or sentence case. 
...
gender_score <- function(dataset, gender2){
# gender options are : female, male, i'd rather not say, other
...
gender_score(candy, "i'd rather not say")
...
total_scores2 <- as.data.frame(t(total_scores)) %>% 
  rownames_to_column()
