...
# Adding results from running the function with each gender to dataframe
    rbind(high_score_by_gender(candy_num_ratings, "female"), high_score_by_gender(candy_num_ratings, "male"), 
        high_score_by_gender(candy_num_ratings, "i'd rather not say"), high_score_by_gender(candy_num_ratings, "other"))
...
# Adding results from running the function with each year to dataframe
    rbind(high_score_by_year(candy_num_ratings, 2015),              high_score_by_year(candy_num_ratings, 2016), 
...
rbind(high_score_by_country(candy_num_ratings, "usa"), high_score_by_country(candy_num_ratings, "canada"), 
...
There is a draw for the most popular candy in all other countries. These numbers seem low. If I have time I'll go back and check them. 
...
rbind(top_3_by_country(candy_num_ratings, "usa"), top_3_by_country(candy_num_ratings, "canada"), 
